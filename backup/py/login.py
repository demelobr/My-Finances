...
# Form implementation generated from reading ui file '/home/bruno/Desktop/Bruno/My Codes/Qt/finance_control_project_python/ui/login.ui'
#
...
"}")
        ...
        self.fr_logo.setStyleSheet("background-image: url(:/logo/finance2.png);\n"
"background-repeat: no-repeat;\n"
"background-position: center;")
...
"}")
        ...
        self.lb_question.setGeometry(QtCore.QRect(50, 340, 199, 19))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn_click_here.setGeometry(QtCore.QRect(250, 340, 71, 17))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"padding-right: 5px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lb_question.setText(_translate("MainWindow", "You don\'t have your account yet?"))
