...
def plot(main, months, time, title: str, axis_x_name: str, axis_y_name: str, legend: str, color: str):
    ...
    """
        ...
        :param - main: main window context.
               ...
               - time: list with the values of each month.
               - title: graph title
               - x: axis x name
               - y: axis y name
    ...
    data_line = main.graphWidget.plot(months, time, name =legend, pen=pen)
...
def set_graph(main, username: str):
    ...
    month_min_num = month_number(month_min)
    month_max_num = month_number(month_max)

#    print(f"min_num: {month_min_num}")
#    print(f"max_num: {month_max_num}")
    ...
    if(month_min_num == -1 and month_max_num == -1):
        month_min = "January"
        month_max = "December"
        month_min_num = 1
        month_max_num = 12

    data_expenses = get_data(username, "EXPENSES", month_min_num, month_max_num, year)
    data_revenue = get_data(username, "REVENUE", month_min_num, month_max_num, year)
...
def revenue_list(main, username: str, tab: str):
    ...
    if(tab == "home"):
        ...
        month_min = month_number(month_min)
        month_max = month_number(month_max)
        ...
        data = get_data(username, register_type, month_min, month_max,year)
        ...
        data = get_data(username, register_type, month_min, month_max, year, value_min, value_max)
